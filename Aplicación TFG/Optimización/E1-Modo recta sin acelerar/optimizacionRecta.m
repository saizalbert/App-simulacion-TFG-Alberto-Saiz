...
rangoLong=200;
rangoMedia=300; 
rango=linspace(0,0.1, rangoLong); 
...
%%
[datosBlanco,N, modF]=blancoRecta(param);
cont=1; 
for q=rango
    cuentaNoVale=0;
    fallos=0;
    ...
    precisionVelMedia=zeros(rangoMedia,3);
    ...
    for k=1:rangoMedia
        ...
        if ~errorKalman{1}.existeTraza
            ...
            precisionVelMedia(k,:)=precisionVelMedia(k-1,:);
        ...
        precisionVelMedia(k,:)=errorKalman{1}.precisionVelFinal;
        ...
        precisionVel(cont,:)=mean(precisionVelMedia);
